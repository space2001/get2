...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mansione.nome'
        db.alter_column('calendario_mansione', 'nome', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Mansione.nome'
        db.alter_column('calendario_mansione', 'nome', self.gf('django.db.models.fields.CharField')(max_length=200))
