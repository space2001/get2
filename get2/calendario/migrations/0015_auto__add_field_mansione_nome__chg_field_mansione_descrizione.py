...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mansione.nome'
        db.add_column('calendario_mansione', 'nome',
                      self.gf('django.db.models.fields.CharField')(default='xxx', max_length=200),
                      keep_default=False)


        # Changing field 'Mansione.descrizione'
        db.alter_column('calendario_mansione', 'descrizione', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'Mansione.nome'
        db.delete_column('calendario_mansione', 'nome')


        # Changing field 'Mansione.descrizione'
        db.alter_column('calendario_mansione', 'descrizione', self.gf('django.db.models.fields.CharField')(max_length=200))
