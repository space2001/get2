...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('calendario_disponibilita', 'mansione_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendario.Mansione'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Disponibilita.mansione'
        raise RuntimeError("Cannot reverse this migration. 'Disponibilita.mansione' and its values cannot be restored.")
