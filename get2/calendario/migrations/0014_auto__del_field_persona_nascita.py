...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Persona.nascita'
        db.delete_column('calendario_persona', 'nascita')


    def backwards(self, orm):
        # Adding field 'Persona.nascita'
        db.add_column('calendario_persona', 'nascita',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 7, 0, 0)),
                      keep_default=False)
