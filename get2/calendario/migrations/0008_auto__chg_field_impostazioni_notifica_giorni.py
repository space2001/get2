...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('calendario_impostazioni_notifica', 'giorni', self.gf('get2.calendario.models.MultiSelectField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Impostazioni_notifica.giorni'
        db.alter_column('calendario_impostazioni_notifica', 'giorni', self.gf('django.db.models.fields.CharField')(max_length=20))
