...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Turno.tipo'
        db.alter_column('calendario_turno', 'tipo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendario.TipoTurno'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Turno.tipo'
        db.alter_column('calendario_turno', 'tipo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL))
