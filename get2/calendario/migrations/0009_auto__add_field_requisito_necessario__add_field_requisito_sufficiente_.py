...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requisito.necessario'
        db.add_column('calendario_requisito', 'necessario',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Requisito.sufficiente'
        db.add_column('calendario_requisito', 'sufficiente',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Requisito.visibile'
        db.add_column('calendario_requisito', 'visibile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requisito.necessario'
        db.delete_column('calendario_requisito', 'necessario')

        # Deleting field 'Requisito.sufficiente'
        db.delete_column('calendario_requisito', 'sufficiente')

        # Deleting field 'Requisito.visibile'
        db.delete_column('calendario_requisito', 'visibile')
    ...
    models = {
        ...
        'calendario.requisito': {
            ...
            'visibile': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
