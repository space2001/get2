...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.stato'
        db.alter_column('calendario_persona', 'stato', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'Persona.stato'
        db.alter_column('calendario_persona', 'stato', self.gf('django.db.models.fields.DateField')())
