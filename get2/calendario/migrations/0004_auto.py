...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field richiede on 'Mansione'
        db.create_table('calendario_mansione_richiede', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_mansione', models.ForeignKey(orm['calendario.mansione'], null=False)),
            ('to_mansione', models.ForeignKey(orm['calendario.mansione'], null=False))
        ))
        db.create_unique('calendario_mansione_richiede', ['from_mansione_id', 'to_mansione_id'])


    def backwards(self, orm):
        # Removing M2M table for field richiede on 'Mansione'
        db.delete_table('calendario_mansione_richiede')
    ...
    models = {
        ...
        'calendario.mansione': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'richiede': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'richiede_rel_+'", 'null': 'True', 'to': "orm['calendario.Mansione']"})
        },
        'calendario.notifica': {
