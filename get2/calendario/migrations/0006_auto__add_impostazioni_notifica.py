...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Impostazioni_notifica'
        db.create_table('calendario_impostazioni_notifica', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('utente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='impostazioni_notifica_utente', to=orm['auth.User'])),
            ('giorni', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('tipo_turno', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendario.TipoTurno'], null=True, on_delete=models.SET_NULL, blank=True)),
        ))
        db.send_create_signal('calendario', ['Impostazioni_notifica'])


    def backwards(self, orm):
        # Deleting model 'Impostazioni_notifica'
        db.delete_table('calendario_impostazioni_notifica')
    ...
    models = {
        ...
        'calendario.impostazioni_notifica': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tipo_turno': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['calendario.TipoTurno']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
