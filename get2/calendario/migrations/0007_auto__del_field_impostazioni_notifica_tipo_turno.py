...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Impostazioni_notifica.tipo_turno'
        db.delete_column('calendario_impostazioni_notifica', 'tipo_turno_id')

        # Adding M2M table for field tipo_turno on 'Impostazioni_notifica'
        db.create_table('calendario_impostazioni_notifica_tipo_turno', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('impostazioni_notifica', models.ForeignKey(orm['calendario.impostazioni_notifica'], null=False)),
            ('tipoturno', models.ForeignKey(orm['calendario.tipoturno'], null=False))
        ))
        db.create_unique('calendario_impostazioni_notifica_tipo_turno', ['impostazioni_notifica_id', 'tipoturno_id'])


    def backwards(self, orm):
        # Adding field 'Impostazioni_notifica.tipo_turno'
        db.add_column('calendario_impostazioni_notifica', 'tipo_turno',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendario.TipoTurno'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Removing M2M table for field tipo_turno on 'Impostazioni_notifica'
        db.delete_table('calendario_impostazioni_notifica_tipo_turno')
    ...
    models = {
        ...
        'calendario.impostazioni_notifica': {
            ...
            'giorni': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
