...
var Dajaxice = {
    ...
    mansione_form: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.mansione_form', 'POST', callback_function, argv, custom_settings);
    },

    utente_persona: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.utente_persona', 'POST', callback_function, argv, custom_settings);
    },

    elimina_persona: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.elimina_persona', 'POST', callback_function, argv, custom_settings);
    },

    notifiche: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.notifiche', 'POST', callback_function, argv, custom_settings);
    },

    requisito_form: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.requisito_form', 'POST', callback_function, argv, custom_settings);
    },

    utente_staff: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.utente_staff', 'POST', callback_function, argv, custom_settings);
    },

    elimina_tipo_turno: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.elimina_tipo_turno', 'POST', callback_function, argv, custom_settings);
    },

    tipo_turno_form: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.tipo_turno_form', 'POST', callback_function, argv, custom_settings);
    },

    elimina_utente: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.elimina_utente', 'POST', callback_function, argv, custom_settings);
    }
